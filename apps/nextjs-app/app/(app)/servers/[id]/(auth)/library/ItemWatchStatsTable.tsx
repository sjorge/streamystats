...
export function ItemWatchStatsTable({
  ...
  const columns: ColumnDef<ItemWatchStats>[] = [
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              ...
              {row.original.item.productionYear &&
                ` • ${row.original.item.productionYear}`}
    ...
    {
      accessorFn: (row) => row.item.officialRating,
      id: "official_rating",
      header: () => (
        <Button
          variant="ghost"
      ...
      cell: ({ row }) => (
        <div className="text-left">
          {row.original.item.officialRating || "-"}
        </div>
      ),
      size: 80,
      minSize: 60,
    ...
    {
      accessorFn: (row) => row.item.communityRating,
      id: "community_rating",
      header: () => (
        <Button
          variant="ghost"
    ...
    {
      accessorFn: (row) => row.item.runtimeTicks,
      id: "runtime",
      header: () => (
      ...
      cell: ({ row }) => {
        const ticks = Number(row.original.item.runtimeTicks);
